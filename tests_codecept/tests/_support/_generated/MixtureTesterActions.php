<?php  //[STAMP] 06beed0cad81286129642642a70e7d30
...
trait MixtureTesterActions
{
     ...
     * @see \Helper\Mixture::getPublicModule()
     */
    public function getPublicModule($name) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getPublicModule', func_get_args()));
    }
     ...
     *
     * @return \Codeception\Module
     * @see \Helper\Mixture::getPublicModules()
     */
    public function getPublicModules() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getPublicModules', func_get_args()));
    }
